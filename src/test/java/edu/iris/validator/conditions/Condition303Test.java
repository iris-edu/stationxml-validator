...
public class Condition303Test {
	...
	public void fail() throws Exception {
		try (InputStream is = RuleEngineServiceTest.class.getClassLoader().getResourceAsStream("F1_303.xml")) {
			...
			CalibrationUnitCondition condition = new CalibrationUnitCondition(true, "");
